...
(global-set-key (kbd "C-q C-i") 'anything-for-imenu)
...
;; make warning, use delete-duplicates in runtime.
...
;;     (loop for family in (sort
;;                          (delete-duplicates (font-family-list)) 'string<)
;;           do (insert
